...
def train(args, loader, model, criterion, optimizer, log, epoch, recorder):
    ...
    # GR_Net, MF_Net, NormAttention_Net = other_metheds
    for i, sample in enumerate(loader):
        ...
        optimizer.zero_grad()
        # loss = criterion.forward(out_var, data['tar'], [GR_Net_out_var, NormAttention_out_var, MF_Net_out_var])
        ...
        del i, sample, data, input, out_var, loss, iters
